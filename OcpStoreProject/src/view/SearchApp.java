		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(tmp.length()==1) {
						...
						if(tsSt == "Code") {
							...
							if(dataSize > 1) {
								...
								for(int i = 0; i < dataSize; i++) {
									str[i] = customerList.get(i).getC_Code();
								}
								option = str;
					...
					textc_code.setText(customerUser.getC_Code());
					textc_name.setText(customerUser.getC_Name());
					textc_phone.setText(customerUser.getC_Phone());
					textc_point.setText(Integer.toString(customerUser.getC_Point()));
					textc_note.setText(customerUser.getC_Remark());
